...
final class LyricsContentViewSnapshotTests: XCTestCase {
    ...
    private func makePrefs(style: Cantio.WindowStyle, bgStyle: Cantio.BackgroundStyle, tone: Cantio.Tone) -> Preferences {
    ...
    private func makeView(style: Cantio.WindowStyle, bgStyle: Cantio.BackgroundStyle, tone: Cantio.Tone) -> some View {
    ...
    func test_lyricsContent_minimal_solid_light() {
        let view = makeView(style: Cantio.WindowStyle.minimal, bgStyle: Cantio.BackgroundStyle.solid, tone: Cantio.Tone.light)
    ...
    func test_lyricsContent_minimal_glass_dark() {
        let view = makeView(style: Cantio.WindowStyle.minimal, bgStyle: Cantio.BackgroundStyle.glass, tone: Cantio.Tone.dark)
        assertSnapshot(of: host(view, size: CGSize(width: 520, height: 120)),
                       as: .image(precision: 0.99, perceptualPrecision: 0.96))
    }

    func test_lyricsContent_pill_glass_dark() {
        let view = makeView(style: Cantio.WindowStyle.pill, bgStyle: Cantio.BackgroundStyle.glass, tone: Cantio.Tone.dark)
